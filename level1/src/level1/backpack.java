...
public class backpack {
	...
	public static void main (String[] args){
		/* Your mission is to get to school, but first you need to get all of your supplies into your backpack. */
		 backpack jeff = new backpack();
		 Pencil bill = new Pencil();
		 Ruler bob = new Ruler();
		 Textbook jimeh = new Textbook();
		 jeff.putInBackpack( bill );
		 jeff.putInBackpack( bob );
		 jeff.putInBackpack( jimeh );
		 jeff.goToSchool();
		 bob.measure();
		 bill.write("I can write with meh pencil");
		 jimeh.read();
	}
