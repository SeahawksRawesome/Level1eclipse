...
public class eatmeh extends KeyAdapter {
int tries;
JFrame jFrame;
...
private void makeAlbum() {
	...
	System.out.println("Hello, up arrow is spoon, left arrow is knife, right arrow is fork, and down is chopsticks");
	// 2. Connect the images to the UP, DOWN, LEFT, and RIGHT keys like
	// this...
	
	images.put(new Integer(KeyEvent.VK_UP), "Froot-Loops-Cereal-Bowl.jpg"); // the spoon will be connected to the UP key
	images.put(new Integer(KeyEvent.VK_LEFT), "url.jpg");
	images.put(new Integer(KeyEvent.VK_DOWN), "imgres.jpg");
	images.put(new Integer(KeyEvent.VK_RIGHT), "cheese.jpg"); // the chopstick will be connected to the LEFT key
...
private void showImage() {
	...
	tries += 1;
	if(tries >= 10){
		System.out.println("Sorry, you've played enough.");
		jFrame.dispose();
		System.out.println("your score is" + track);
	}
	// 6. Pack the frame
	jFrame.pack();
...
public void keyPressed(KeyEvent e) {
	...
	// 11. Otherwise, tell the user that they should learn some manners
			...
			System.out.println("you better learn some manners.");
		track -= 1;
		}
